...
do for [i=0:100000000:100000]{       #[i=初期ステップ数:最終ステップ:飛んでいるデータ数]
    i2 = i/100000 #ファイル名が飛んでいる場合
    filename = sprintf("./png/net_%05d.png",i2) #ディレクトリpngを作って動かす
    step = sprintf("\"Turing2c1k8\"   time = %f",i*1/100000.0)
    set title step
    dataname = sprintf("./Turing2_a02b146/data%d.txt",i) #変更
...
#gnuplotで  load "png3d.gnu"  で2次元データをpng画像に.
#アニメーションは端末で↓
